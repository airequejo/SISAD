          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <a type="button" class="breadcrumb-item btn  btn-info btn-xs" onclick="nuevo();" >
                  <b><i class="fas fa-user-plus"></i> Nuevo periodo</b></a>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Listado de peridos</h3>
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-md-12">      
                  <div class="form-group">
                    <label>DESCRIPCIÓN DEL PERIDO</label>
                    <input type="hidden" name="idperiodo" id="idperiodo">
                    <input class="form-control" type="text" name="descripcion" id="descripcion" placeholder="Ejemplo: 2022-I" required>
                  </div>  
                </div>
...
<?php } else {require 'noacceso.php';}
    ...
    require 'footer.php';
    ?>
  <script type="text/javascript" src="scripts/periodos.js"></script>
<?php
}
ob_end_flush();
?>
