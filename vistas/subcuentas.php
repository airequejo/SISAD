          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <a type="button" class="breadcrumb-item btn  btn-info btn-xs" onclick="nuevo();" >
                  <b><i class="fas fa-user-plus"></i> Nueva subcuenta</b></a>
              </li>
            </ol>
          </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-12">
                  <div class="form-group">
                    <label>CÓDIGO DE SUBCUENTA</label>
                    <input type="hidden" name="idsubcuenta" id="idsubcuenta">
                    <input class="form-control" type="number" name="codigosubcuenta" id="codigosubcuenta" placeholder="Ejemplo 701" required >
                  </div>               
                </div>

                <div class="col-xl-6 col-md-12">      
                  <div class="form-group">
                    <label>DESCRIPCIÓN SUB CUENTA</label>
                    <input class="form-control" type="text" name="descripcion" id="descripcion" placeholder="Ingrese descripción de la subcuenta" required >
                  </div>  
                </div>
...
<?php } else {require 'noacceso.php';}
    ...
    require 'footer.php';
    ?>
  <script type="text/javascript" src="scripts/subcuentas.js"></script>
<?php
}
ob_end_flush();
?>
