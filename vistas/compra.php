                        ...
                        <div class="form-group  col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          ...
                          $fecha_vence=date('Y-m-d'); 
                           ...
                           ?>
                            ...
                            <label>FECHA</label>
                            <input type="date" class="form-control" name="fecha" id="fecha" style="border-radius: 5px;" required data-format="dd/MM/yyyy" min="<?php echo date("Y-m-d",strtotime($fecha.'- 5 days'));?>" max="<?php echo $fecha; ?>" value="<?php echo date('Y-m-d'); ?>">
                          </div>
