          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <a type="button" class="breadcrumb-item btn  btn-info btn-xs" onclick="nuevo();" >
                  <b><i class="fas fa-user-plus"></i> Nueva divisionaria</b></a>
              </li>
            </ol>
          </div>
        </div>
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Listado de divisionarias</h3>
        ...
        <!-- INICIO AREA DE TRABAJO  --> 
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <th>CUENTA</th>
              <th>SUBCUENTA</th>
              <th>DESCRIPCIÓN DIVISIONARIA</th>
              <th>OPCIONES</th>
            </tr>
            </thead>
...
<?php } else {require 'noacceso.php';}
    ...
    require 'footer.php';
    ?>
  <script type="text/javascript" src="scripts/divisionarias.js"></script>
<?php
}
ob_end_flush();
?>
