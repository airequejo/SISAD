...
$tipoproceso=$reg->tipoproceso;
    ...
    if ($tipoproceso=='1')
     ...
     if ($tipoproceso=='3')
     {
        ...
        $ruta_qr = '../../../../app_jeam/public/sis_facturacion/archivos_xml_sunat/cpe_xml/'.$ruta_tipo_proceso.'/'.$documento.'/qr/'.$nombreqr.'.png';
    ...
    while ($regd = $rsptad->fetch_object()) {
     ...
     $detalle_ven=$detalle_ven;
      ...
      $tipotransaccion =  '<tr>
      <td colspan="5"><b>Tipo de Transacción:</b> Crédito</td>
    </tr>
    <tr>
      <td colspan="5"><b>Información del crédito:</b></td>
    </tr>
    <tr>
      <td colspan="5">Monto neto pendiente de pago :</b>'.$regv->total_venta.'  </td>
    </tr>
    <tr>
      <td colspan="5">Fecha vencimiento :</b>'.date("d-m-Y",strtotime($regv->fecha_vencimiento)).'  </td>
    </tr>';
    }
    else{

     $tipotransaccion = '<tr>
    <td colspan="5"><b>Tipo de Transacción :</b> Contado</td>
  </tr>';
...
<!-- codigo imprimir -->
          ...
          <!--  <img align="left" src="encabezado.jpg" width="700px" height="120"> -->
...
<table border="0" align="center" width="200%">
    <tr>
        ...
        <h1><strong>'.$razon.'</strong><br>DE: '.$empresa.'</h1>
        <h3><p>'.$servicio.'</p></h3>
    ...
    <tr>
        <td align="" colspan="3">FECHA DE EMISIÓN:'.date("d-m-Y H:i:s",strtotime($regv->fecha_hora)).'</td>
    </tr>
    <tr>
                ...
                <tbody>
                    <tr>    
                        <td class="fg2" colspan="5" align="center"><img src="'.$ruta_qr.'" width="120" height="120" /></td>                    
                         <td>
                            <div>Representación impresa de la '. $regv->tipocomprobante.' 
                            .Consulte en portal sunat <br /></div>
                            <div>'. $reg->mensaje1.'<br /></div>
...
$output = $mipdf->output();
file_put_contents('../../../../app_jeam/public/sis_facturacion/archivos_xml_sunat/cpe_xml/'.$ruta_tipo_proceso.'/'.$documento.'/pdf/'.$nombre_pdf.'.PDF', $output);
