...
$this->SetFont('Arial','',8);
	...
	$y1  = $this->h - 40;
	$this->SetFont( "Arial", "", 8);
	$total_general=$total*(1+($igv/100));
	$igv_general=($total_general/(1+($igv/100)));
	$this->SetXY( $re, $y1+5 );
	$this->Cell( 17,4, $moneda.sprintf("%0.2F", $igv_general), '', '', 'R');
	$this->SetXY( $re, $y1+10 );
	
	$this->Cell( 17,4, $moneda.sprintf("%0.2F",  $total_general-$igv_general), '', '', 'R');
	$this->SetXY( $re, $y1+14.8 );
	$this->Cell( 17,4, $moneda.sprintf("%0.2F", $total_general), '', '', 'R');
