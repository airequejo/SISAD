...
<table border="0" align="center" width="90%">
    ...
    $sumatoria=$sumatoria+$regc->total;
        ...
        while ($regdi = $rsptadi->fetch_object()) {
            echo "<tr><td valign='top'>&nbsp;</td><td valign='top'>&nbsp;</td><td colspan='5'><font size='1px'>".$regdi->codigodivisionaria." ".$regdi->divisionaria."</font></td><td align='right'><font size='1px'>".$regdi->total."</font></td><td>&nbsp;</td><td>&nbsp;</td></tr>";
