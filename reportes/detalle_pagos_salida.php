...
require_once "../modelos/Cuentaspagarporproveedor.php";
//Instanaciamos a la clase con el objeto venta
$venta = new Compra();
$credito = new Cuentaspagarporproveedor();
    ...
    <tr>
      <td align="center" colspan="3"></td>
        ...
        <td colspan="3">
            ...
            <hr>
            <?php
                echo "PROVEEDOR: ".$regc->nombre."<br>DNI/RUC Nº: ".$regc->dniruc."<br>DIRECCIÓN: ".$regc->direccion;
                echo "<br><hr><b>INFORMACIÓN DEL CRÉDITO</b><br><hr>FECHA CRÉDITO: ".$regc->fecha_credito."<br>Monto Compra S/: ".$regc->monto_compra."<br>Pag Inicial S/: ".$regc->montoabonado."<br>Monto Crédito S/: ".$regc->monto_credito."<br>Deuda Actual S/: ".$regc->deuda_actual;
            ?>
            <hr>
        </td>
    </tr> 
