...
<table border="0" align="center" width="600">
    <tr>
        <td align="center">
            <img align="left" src="logo.jpg" width="180" height="120">
            </td>
            <td align="center">
        <!-- Mostramos los datos de la empresa en el documento HTML -->
        <h1><strong> <?php echo $empresa; ?></strong></h1><br> <h3><p><?php echo $servicio; ?></p></h3>
    ...
    <tr>
        <td align="center" colspan="3">FECHA DE EMISIÓN: <?php echo date("d-m-Y H:i:s",strtotime($regv->fecha_hora)); ?></td>
    </tr>
    <tr>
